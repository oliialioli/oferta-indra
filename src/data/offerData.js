...
export const screens = {
  intro: {
    ...
    headline: '¡Hola, Raquel! Tu próxima misión puede comenzar aquí.',
    body: [
      'Aquí tienes todos los detalles de tu propuesta como CNS Training Instructor: condiciones, beneficios y oportunidades en Indra Group.',
  ...
  sectors: {
    ...
    body: 'Formarás parte de una compañía tecnológica global que vive uno de sus momentos más relevantes, transformando sectores estratégicos.',
