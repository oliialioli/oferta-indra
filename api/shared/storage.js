...
function toEntity(offer) {
  return {
    ...
    offerValidityDays: offer.offerValidityDays ?? null,
    sourceDocBlobUrl: offer.sourceDocBlobUrl,
    sourceDocBlobName: offer.sourceDocBlobName || null,
    sourceDocFileName: offer.sourceDocFileName || null,
...
function fromEntity(entity) {
  return {
    ...
    offerValidityDays: entity.offerValidityDays ?? null,
    sourceDocBlobUrl: entity.sourceDocBlobUrl,
    sourceDocBlobName: entity.sourceDocBlobName || null,
    sourceDocFileName: entity.sourceDocFileName || null,
